...
public class PageData<T> implements Serializable
{
     ...
     * @return List 一页的数据
     */
    public static <T> PageData<T> getByList(List<T> list, int pageNo, int pageSize)
    {
    ...
    {
        return String
                .format("PageData [pageData=%s, pageNo=%s, pageSize=%s, dataTotal=%s, pageTotal=%s, prevPage=%s, nextPage=%s, nextCursor=%s]",
                        pageData, pageNo, pageSize, dataTotal, pageTotal, prevPage, nextPage, nextCursor);
    }
    ...
    public static void main(String[] args)
    {
        ...
        PageData<String> p = getByList(l, 1, 1);
